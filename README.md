...
# 0501springboot牙科诊所管理系统pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1eMbYemE1U?p=3)
...
![C:/Users/Administrator/Desktop/temp111\3.3\\_\_\_\_img\用户.jpg](/md/blog.003.jpeg)

用户实体属性图

（2）下图是公告实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3.3\\_\_\_\_img\公告.jpg](/md/blog.004.jpeg)

公告实体属性图

（3）下图是医生预约实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3.3\\_\_\_\_img\医生预约.jpg](/md/blog.003.jpeg)

医生预约实体属性图

（4）下图是病例实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3.3\\_\_\_\_img\病例.jpg](/md/blog.003.jpeg)

病例实体属性图

（5）下图是医生实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3.3\\_\_\_\_img\医生.jpg](/md/blog.003.jpeg)
...
|6|bingli\_types|Integer|病例类型|是|
|7|kanbing\_time|Date|看病时间|是|
|8|bingli\_zishu\_text|String|病人自述|是|
|9|bingli\_zhenduan\_text|String|诊断结果|是|
|10|bingli\_yaofang\_text|String|药方|是|
|11|bingli\_huafei|BigDecimal|花费金额|是|
|12|jiaofei\_types|Integer|是否缴费|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yisheng\_uuid\_number|String|医生编号|是|
...
|7|yisheng\_email|String|医生邮箱|是|
|8|zhiwei\_types|Integer|职位|是|
|9|yisheng\_content|String|医生介绍|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yisheng\_yuyue\_uuid\_number|String|预约唯一编号|是|
|3|yisheng\_id|Integer|医生|是|
|4|yonghu\_id|Integer|用户|是|
|5|yisheng\_yuyue\_text|String|预约理由|是|
|6|insert\_time|Date|申请预约时间|是|
|7|yisheng\_yuyue\_time|Date|预约时间|是|
|8|yisheng\_yuyue\_yesno\_types|Integer|预约状态|是|
|9|yisheng\_yuyue\_yesno\_text|String|预约回复|是|
|10|yisheng\_yuyue\_shenhe\_time|Date|回复时间|是|
